<template>
    <div class="project-list">
        <div class="project-list__btn">
            <button class="btn btn-primary" @click="state.showModal = true">Créer un projet</button>
        </div>
        ...
        <vue-final-modal v-model="state.showModal" classes="modal-container" content-class="modal-content">
            ...
            <div class="modal__content">
                <div class="project-list__form">
                    <div class="form-control w-full">
                        ...
                        <input type="text" :class="[{ 'input-error': v$.name.$error }, 'input input-bordered rounded-md w-full']"
                            v-model="state.name" />
                    ...
                    <div class="form-control w-full">
                        <label class="label justify-start gap-3">Description <span
                                class="badge badge-sm">Optionnel</span></label>
                        <textarea class="textarea textarea-bordered" v-model="state.description"></textarea>
                    </div>
                    <div class="form-control w-full">
                        <label class="label justify-start gap-3">Image <span
                                class="badge badge-sm">Optionnel</span></label>
            ...
            <div class="modal__action">
                ...
                <button @click="handleLoginClick" :class="[{ 'loading': state.isLoading }, 'btn btn-primary']">{{
