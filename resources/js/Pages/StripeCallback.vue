            ...
            <div class="devis__content">
                ...
                <div v-if="isSuccess" class="bg-gray-200 w-full px-16 md:px-0 h-screen flex items-center justify-center">
                    <div class="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
                        ...
                        <p v-if="this.account && this.account.type === 'customer'" class="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-gray-500 mt-4">Vous allez pouvoir effectuer votre premier paiement.</p>
                        <p v-else class="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-gray-500 mt-4">Vous allez pouvoir recevoir votre premier paiement.</p>
                        <p class="text-gray-500 mt-4 pb-4 border-b-2 text-center">Vous serez redirigé dans 5 secondes ... <a :href="this.redirectUrl">ou cliquez ici</a></p>
                    </div>
                </div>
