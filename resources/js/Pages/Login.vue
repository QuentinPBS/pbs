    ...
    <div class="login">
      <div class="login__block">
        ...
        <div class="login__form">
          ...
          <div class="form-control w-full my-2">
            <router-link
              ...
              to="/reset-password"
              >{{ $t("login.forgot_password_question") }}</router-link
            >
          </div>
          <div class="form-control w-full mt-6">
            ...
            >
              {{ state.isLoading ? $t("loading") : $t("login.sign_in") }}
            </button>
          </div>
        </div>
        ...
        <p>
          ...
          <router-link class="underline text-primary" to="/register">{{
            $t("login.sign_up")
          }}</router-link>
        </p>
      </div>
