                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-24"
                                                ...
                                                lang="x-size-24"><span
                                                    style="text-decoration: inherit;color: #8690a8;">Bonjour,</span></h1>
                                            <h3 class="size-24"
                                                style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #b8bdc9;font-size: 20px;line-height: 28px;text-align: left;"
                                                lang="x-size-24"><span
                                                    style="text-decoration: inherit;color: #8690a8;">Vous trouvez ci joint un fichier
                                                    de reporting </span></h3>
                                        </div>
                                    </div>
