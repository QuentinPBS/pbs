                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        style="display: block;height: auto;width: 100%;border: 0;max-width: 105px;"
                                        src="images/Essai_logo_211.png" alt="" width="105" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                    </div>
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-24"
                                                style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #b8bdc9;font-size: 20px;line-height: 28px;text-align: left;"
                                                lang="x-size-24"><span
                                                    style="text-decoration: inherit;color: #8690a8;">{{ $invitation->user->lastname }} {{ $invitation->user->firstname }} vous
                                                    invite dans le projet {{ $invitation->project->name }}</span></h1>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div class="btn btn--flat fullwidth btn--large"
                                            ...
                                            <![if !mso]><a
                                                style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #570df8;font-family: Lato, Tahoma, sans-serif;"
                                                href="{{ env('APP_URL') }}/devis">Rejoindre le groupe</a>
                                            <![endif]>
                                            <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://example.com" style="width:560px" arcsize="9%" fillcolor="#570DF8" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Lato,Tahoma,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Rejoindre le groupe</center></v:textbox></v:roundrect><![endif]-->
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                        <div
                                            ...
                                            <p class="size-17"
                                                ...
                                                lang="x-size-17"><strong>L'&#233;quipe Paybystep</strong></p>
                                        </div>
                                    </div>
                    ...
                    <div role="contentinfo">
                        ...
                        <div class="layout email-flexible-footer email-footer"
                            ...
                            <div class="layout__inner right-aligned-footer"
                                ...
                                <table
                                    style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 600px;"
