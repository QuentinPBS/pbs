                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-24"
                                                ...
                                                lang="x-size-24"><span
                                                    style="text-decoration: inherit;color: #8690a8;">Le projet avance, connectez-vous pour découvrir les avancées</span></h1>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div class="btn btn--flat fullwidth btn--large"
                                            ...
                                            <![if !mso]><a
                                                ...
                                                href="{{ env('APP_URL') }}/devis">Prochaine étape</a>
                                            <![endif]>
